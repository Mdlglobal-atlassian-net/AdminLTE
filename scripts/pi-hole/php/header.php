...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; base-uri 'none'; child-src 'self'; form-action 'self'; frame-src 'self'; img-src 'self' data:; manifest-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'">
                    ...
                    <?php
                        ...
                        if ($FTL) {
                            if ($celsius >= -273.15) {
                                ...
                                ?>
                                "\"></i> Temp:&nbsp;<span id="rawtemp" hidden><?php echo $celsius; ?></span><span id="tempdisplay"></span>
                                <?php
                            }
                                } else {
